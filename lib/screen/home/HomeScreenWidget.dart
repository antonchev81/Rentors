...
class HomeScreenWidgetState extends RentorState<HomeScreenWidget> {
      ...
      child: Container(
        ...
        child: Card(
          ...
          child: ClipRRect(
              borderRadius: BorderRadius.circular(5.0),
              child: Container(
                color: config.Colors().pink, //mCategory.color,
                child: Column(
  ...
  Widget twoCategory(Category mCategory, Category two, int index) {
    return Container(
            ...
            child: InkWell(
              ...
              child: Card(
                color: index.isEven
                    ...
                    : config.Colors().pink, //mCategory.color,
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(5.0),
                ),
                child: ClipRRect(
                    ...
                    builder: (BuildContext context, BaseState state) {
                      if (state is ErrorState) {
                        ...
                        return Column(
                          ...
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            CenterHorizontal(CircularProgressIndicator())
                          ],
                        );
                      } else {
                        if (state is HomeState) {
            ...
            child: ListView.builder(
                ...
                itemBuilder: (BuildContext ctxt, int index) {
                  if (category[index] is TwoCategoryCategory) {
                    ...
                    return twoCategory(two.category, two.category2, index);
                  } else {
